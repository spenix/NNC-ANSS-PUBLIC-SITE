...
export default function CustomPaginationActionsTable({rows = []}) {
  ...
  return (
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: isMobile ? 1000 : 500 }} aria-label="Indicators Registry List">
      <TableHead style={{backgroundColor:"#e6eaeb"}}>
          <TableRow>
            <TableCell style={{fontWeight:"bold"}}>CODE</TableCell>
            <TableCell style={{fontWeight:"bold"}}>INDICATOR NAME</TableCell>
            <TableCell style={{fontWeight:"bold"}}>DESCRIPTION</TableCell>
            <TableCell style={{fontWeight:"bold"}}>INDICATOR TYPE</TableCell>
            <TableCell style={{fontWeight:"bold"}}>INDICATOR CATEGORY</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {(rowsPerPage > 0
